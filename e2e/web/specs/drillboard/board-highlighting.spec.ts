...
test.describe("board highlighting", () => {
  ...
  test("disable identical values", async ({ resumeDrillGame }) => {
    ...
    const sudokuBoard = new SudokuBoardComponent(resumeDrillGame);
    await sudokuBoard.cell[7][7].click();
    await sudokuBoard.cell[7][7].press("6");
    await sudokuBoard.isSudokuBoardHighlightedCorrectly([
      {
        condition: (row, column) => row === 7 && column === 6,
        color: NOT_SELECTED_CONFLICT_COLOR_RGB,
  ...
  test("disable box", async ({ resumeDrillGame }) => {
    const headerComponent = new HeaderComponent(resumeDrillGame);
    await headerComponent.profile.click();
    const profilePage = new ProfilePage(resumeDrillGame);
  ...
  test("disable rows", async ({ resumeDrillGame }) => {
    const headerComponent = new HeaderComponent(resumeDrillGame);
    await headerComponent.profile.click();
    const profilePage = new ProfilePage(resumeDrillGame);
  ...
  test("disable column", async ({ resumeDrillGame }) => {
    const headerComponent = new HeaderComponent(resumeDrillGame);
    await headerComponent.profile.click();
    const profilePage = new ProfilePage(resumeDrillGame);
  ...
  test("disable all", async ({ resumeDrillGame }) => {
    const headerComponent = new HeaderComponent(resumeDrillGame);
    await headerComponent.profile.click();
    const profilePage = new ProfilePage(resumeDrillGame);
    await profilePage.highlightColumnSwitchEnabled.click();
  ...
  test("disable rows and columns", async ({ resumeDrillGame }) => {
    const headerComponent = new HeaderComponent(resumeDrillGame);
    await headerComponent.profile.click();
    const profilePage = new ProfilePage(resumeDrillGame);
    await profilePage.highlightRowSwitchEnabled.click();
