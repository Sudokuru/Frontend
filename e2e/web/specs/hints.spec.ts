import {
  ...
  OBVIOUS_PAIR_BOX_GAME as OBVIOUS_PAIR_BOX_GAME,
  OBVIOUS_PAIR_COLUMN_GAME as OBVIOUS_PAIR_COLUMN_GAME,
  OBVIOUS_PAIR_PROFILE as OBVIOUS_PAIR_PROFILE,
  OBVIOUS_PAIR_ROW_GAME as OBVIOUS_PAIR_ROW_GAME,
  OBVIOUS_QUADRUPLET_BOX_GAME as OBVIOUS_QUADRUPLET_BOX_GAME,
  OBVIOUS_QUADRUPLET_COLUMN_GAME as OBVIOUS_QUADRUPLET_COLUMN_GAME,
  OBVIOUS_QUADRUPLET_PROFILE as OBVIOUS_QUADRUPLET_PROFILE,
  OBVIOUS_QUADRUPLET_ROW_GAME as OBVIOUS_QUADRUPLET_ROW_GAME,
  OBVIOUS_SINGLE_GAME as OBVIOUS_SINGLE_GAME,
  OBVIOUS_TRIPLET_BOX_GAME as OBVIOUS_TRIPLET_BOX_GAME,
  OBVIOUS_TRIPLET_COLUMN_GAME as OBVIOUS_TRIPLET_COLUMN_GAME,
  OBVIOUS_TRIPLET_PROFILE as OBVIOUS_TRIPLET_PROFILE,
  OBVIOUS_TRIPLET_ROW_GAME as OBVIOUS_TRIPLET_ROW_GAME,
