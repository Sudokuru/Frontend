    ...
    return (
        <View style={styles(cellSize).hintSectionContainer}>
            {(isLeftArrowRendered(onFirstStep))
                ...
                :
                <View style={styles(cellSize, null, sizeConst).hintArrowPlaceholderView}></View>
            }
            <View style={styles(cellSize).hintTextContainer}>
                ...
                <View>
                    <Text style={styles(cellSize, theme.colors.onBackground).hintActionInfoText}>{currentStep == 0 ? hintInfo : hintAction}</Text>
                </View>
            </View>
...
const styles = (cellSize?: number, themeColor?: any, sizeConst?: number) => StyleSheet.create({
