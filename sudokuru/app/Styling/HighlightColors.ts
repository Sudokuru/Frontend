...
export const SELECTED_IDENTICAL_VALUE_COLOR = "#9BC4A0";
export const SELECTED_COLOR = "#9CC4EC";
export const HINT_SELECTED_COLOR = "#F2CA7E";
export const REMOVE_NOTE_TEXT_COLOR = "#FF0000";
export const PLACE_NOTE_TEXT_COLOR = "#000000";
export const PLACE_NOTE_BACKGROUND_COLOR = "#9BC4A0";
...
export const SELECTED_IDENTICAL_VALUE_COLOR_RGB = RGB(
...
export const PLACE_NOTE_BACKGROUND_COLOR_RGB = RGB(PLACE_NOTE_BACKGROUND_COLOR);
export const NOTE_TEXT_COLOR_RGB = RGB(NOTE_TEXT_COLOR);
export const NOT_HIGHLIGHTED_COLOR_RGB = RGB(NOT_HIGHLIGHTED_COLOR);
export const HINT_NOT_HIGHLIGHTED_COLOR_RGB = RGB(HINT_NOT_HIGHLIGHTED_COLOR);
